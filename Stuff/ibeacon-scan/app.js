	...
	function displayBeaconList()
	{
		...
		$.each(beacons, function(key, beacon)
		{
			...
			if (beacon.timeStamp + 60000 > timeNow)
			{
				...
				var beaconMinor = beacon.major;
				var rssi = beacon.rssi;
				if(beaconMinor == 13713 && rssi >= -80) {
					$("#show1").show();
				} else if(beaconMinor == 13713 && rssi < -80){
					$("#show1").hide();
				}
				if(beaconMinor == 11456 && rssi  >= -80){
					$("#show2").show();
				} else if(beaconMinor == 11456 && rssi < -80) {
					$("#show2").hide();
				}

				if(beaconMinor == 34786 && rssi >= -80) {
					$("#show3").show();
				} else if(beaconMinor == 34786 && rssi <-80) {
					$("#show3").hide();
				} 
